...
@testset "Fuselage tank" begin
    @testset "Foam insulation" begin
        ...
        outputs_mech_check = (155813.4902160118, 12.754661771033133, 0.0035645268979941384, 1.9102299646350587, 145.623998835008, 55813.4902160118, 100000.0, 33161.58141606815, 0.003561204259200333, 1565.0564653871652, 15934.428537303356, 1528.102895507448, [10913.366525915251, 12048.59580855156, 10199.619081601335], 192.00106755661065, [15.844936883719953, 19.260709211746004, 23.014988363554576, 27.106823359071385], 14.661327208770198)
    ...
    @testset "Vacuum insulation" begin
        ...
        outputs_vac_size = TASOPT.structures.tanksize!(fuse_tank, z, Mair, xftank,
                                            time_flight,
                                            ifuel)
        outputs_vac_size_check = (203197.13114290315, 0.065, 7.833183975356766, 0.0020612680724211444, 145.623998835008, 100000.0, 51.94395542501284, 0.00435715618585557, 0.004353094705443698, 2.335, 2858.4704423225353, 14495.185531216492, 0.0, [0.0], 10.163826819170911, 103197.13114290315)  
        ...
        outputs_vac_mech_check = (124411.70885967862, 7.833183975356766, 0.00435715618585557, 2.335, 145.623998835008, 24411.708859678612, 100000.0, 0.0, 0.004353094705443698, 2858.4704423225353, 14495.185531216492, 1980.3361838462674, [0.0], 166.54673585196167, [23.675162947566548, 25.28189535258484], 10.163826819170911)
        ...
        outputs_vac_outer_check = (78785.42228322453, 29309.017167216, 12884.34023240256, 16545.413534546627, 168.1077334143945, 24.993050952321795, 118.12163150975091, 0.008906036506379233, 0.018503571497814696)
    ...
    @testset "Stringer sizing" begin
        ...
        Wstiff_check = 1407.1241953786923
