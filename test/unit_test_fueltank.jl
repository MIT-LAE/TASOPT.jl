...
@testset "Fuselage tank" begin
    ...
    @testset "Vacuum insulation" begin
        ...
        outputs_vac_size = TASOPT.structures.tanksize!(fuse_tank, z, Mair, xftank,
                                            time_flight,
                                            ifuel)
        outputs_vac_size_check = (202556.19225053908, 0.065, 7.833183975356766, 0.0020612680724211444, 145.623998835008, 100000.0, 51.94395542501284, 0.00435715618585557, 0.004353094705443698, 2.335, 2858.4704423225353, 14495.185531216492, 0.0, [0.0], 10.163826819170911, 102556.19225053907)  
        ...
        outputs_vac_mech_check = (124335.29733608443, 7.833183975356766, 0.00435715618585557, 2.335, 145.623998835008, 24335.29733608443, 100000.0, 0.0, 0.004353094705443698, 2858.4704423225353, 14495.185531216492, 1910.8711623970096, [0.0], 166.54673585196167, [23.675162947566548, 25.28189535258484], 10.163826819170911)
        ...
        outputs_vac_outer_check = (78220.89491445463, 29124.994401479165, 12884.34023240256, 16216.229601401727, 168.1077334143945, 24.993050952321795, 118.12163150975091, 0.00885011810214525, 0.018503571497814696)
