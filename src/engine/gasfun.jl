...
function gas_H2(t1)# t, tl, cp, cpt,h, s)
    ...
    s = [
        22029,24386,31807,36071,39207,41790,44028,46012,47794,49407,50876,
        52223,53464,54613,55681,56678,57611,58490,59318,60102,60847,61555,
        62231,62877,63496,64090,64661,65212,65743,66256,66752,67233,67700,
        68153,68594,69022,69440,69847,70244,70632,71011, 85217.89022651878,
        87619.82728504791, 89758.90477026274, 91694.79245269607]
    #- - - - - - - - - - -
    ilow::Int = 1
    i::Int = ndim
    #- - - - - - - - - - -
