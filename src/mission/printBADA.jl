function printBADA(io, name, W0, maxalt, TAS, desTAS, ROC, ffpmin, crzf, crzTAS, FLin, Wpaymax; NOx = false, crzNoxEI =[], ffpminNoxEI=[] )
...
# Flight levels to output in BADA file:
    ...
    println(io, @sprintf("    | [kts]       [kg/min]             [g/min]       | [kts]        [fpm]       [kg/min]  [g/min]  | [kts] [fpm] [kg/min]  [g/min] "))
