...
function reset_regression_test(fname, ac)
    ...
    open(fname, "w") do io
        ...
        @printf(io, "wing.layout.x_wing_box = %20.20f \n", wing.layout.x_wing_box)
        @printf(io, "wing.layout.z = %20.20f \n", wing.layout.z)
        @printf(io, "wing.outboard.cos_lambda_strut = %20.20f \n", wing.outboard.cos_lambda_strut)
        @printf(io, "wing.strut.S = %20.20f \n", wing.strut.S)
        @printf(io, "wing.layout.spar_box_x_c = %20.20f \n", wing.layout.spar_box_x_c)
        @printf(io, "wing.layout.box_width_chord = %20.20f \n", wing.layout.box_width_chord)
        @printf(io, "wing.layout.root_chord_thickness = %20.20f \n", wing.layout.root_chord_thickness)
        @printf(io, "wing.layout.spanbreak_chord_thickness = %20.20f \n", wing.layout.spanbreak_chord_thickness)
        ...
        @printf(io, "wing.layout.box_halfspan = %20.20f \n", wing.layout.box_halfspan)
        @printf(io, "wing.layout.ηs = %20.20f \n", wing.layout.ηs)
        @printf(io, "wing.layout.λs = %20.20f \n", wing.layout.λs)
        @printf(io, "wing.layout.λt = %20.20f \n", wing.layout.λt)
        @printf(io, "wing.layout.chord = %20.20f \n", wing.layout.chord)
        @printf(io, "wing.layout.b_inner = %20.20f \n", wing.layout.b_inner)
        ...
        @printf(io, "htail.layout.box_height = %20.20f \n", htail.layout.box_height)
        ...
        @printf(io, "htail.layout.λ = %20.20f \n", htail.layout.λ)
        @printf(io, "htail.layout.box_halfspan = %20.20f \n", htail.layout.box_halfspan)
        ...
        @printf(io, "vtail.layout.box_height = %20.20f \n", vtail.layout.box_height)
        ...
        @printf(io, "vtail.layout.λ = %20.20f \n", vtail.layout.λ)
