...
function reset_regression_test(fname, ac)
    ...
    open(fname, "w") do io
        ...
        @printf(io, "htail.outboard.layout.thickness_to_chord = %20.20f \n", htail.outboard.layout.thickness_to_chord)
        ...
        @printf(io, "vtail.outboard.layout.thickness_to_chord = %20.20f \n", vtail.outboard.layout.thickness_to_chord)
