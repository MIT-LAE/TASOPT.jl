...
pari[iifwcen]   = 0 # Fuel in center box (assumes 0 or 2 in previous flag)
...
# parm[imwOpt   , :]  .=
parm[imRange  , :]  .= 6000.0 * nmi_to_m       # m
...
# Geometry parameters
    ...
    # Sizing load parameters
        ...
        parg[igbmax    ] = 200.0  * ft_to_m # Max span for span constraint ICAO Code D/ FAA Group IV
...
para[iaalt, ipcruise1, :] .=  31977.0 * ft_to_m # Cruise altitude [m] Max fuel max payload
...
pare[ieTt4, 1:iptotal, :] .= 2862.0 # [R]
# pare[ieTt4, ipstatic:iptakeoff, :] .= 3200.0 #[R]
pare[ieTt4, ipstatic:iptakeoff, :] .= 3348.0 #[R]
